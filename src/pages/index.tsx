...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`MarketInsi`}</title>

        <meta
          name="description"
          content="Welcome to MarketInsi - Your trusted partner in navigating the world of Financial Services and Wealth Products. Let's build your financial future together."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to MarketInsi - Your trusted partner in navigating the world of Financial Services and Wealth Products. Let's build your financial future together.`}
            </Text>
            <Box
