...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'financial_service.count', 'wealth_product.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('financial_service', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'financial_service',
          header: 'Financial Service',
          accessorKey: 'financial_service',
          cell: ({ row: { original: record } }: any) => record?._count?.financial_service,
        }
      : null,
    hasAccess('wealth_product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'wealth_product',
          header: 'Wealth Product',
          accessorKey: 'wealth_product',
          cell: ({ row: { original: record } }: any) => record?._count?.wealth_product,
        }
      : null,
