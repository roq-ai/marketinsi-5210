...
import { getWealthProductById } from 'apiSdk/wealth-products';
import { WealthProductInterface } from 'interfaces/wealth-product';

function WealthProductViewPage() {
